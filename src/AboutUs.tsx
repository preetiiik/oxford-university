...
import directorImage from './assets/aboutus/director-img.webp'
import principalImage from './assets/aboutus/principal-img.webp'
...
const chairmanMessage = [
  ...
  'We create multi tasking leaders, emphasizing potential in every student. At Oxford College Hubli, we ensure to deliver quality education because we believe that the power of a nation lies in its youth. An air of academics pervades the whole atmosphere of Oxford teaching faculty, excellent facilities and amenities for students through its well equipped department of studies, library, laboratories, computer labs, recreational hall and assistance round the clock of the non-teaching staff. Oxford College, Hubli is being vibrant in its infrastructure and ambiance. Learning at Oxford College, Hubli therefore is a privilege and a pride.',
  'I warmly welcome the aspiring students into the Oxford Group of Institutions fraternity. I hope you have a tremendous learning and joyful time at Oxford College, Hubli.',
]
