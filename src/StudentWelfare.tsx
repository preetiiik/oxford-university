import scholarshipsHero from './assets/sports/Scholarships & Schemes-hero.png'
import alumniHero from './assets/alumini/alumini-hero.png'
import administrationHero from './assets/sports/administration-cell-hero.png'
import coCurricularHero from './assets/sports/co-curricular-hero.png'
import extraCurricularHero from './assets/sports/extra-curricular-hero.png'
import sportsHero from './assets/sports/sports-hero.png'
...
export function AlumniPage() {
  return <main className="alumni-page student-welfare-page">
    ...
    style={{backgroundImage:`linear-gradient(90deg,rgba(5,12,10,.72),rgba(5,12,10,.5)),url(${alumniHero})`}}>
        <div>
